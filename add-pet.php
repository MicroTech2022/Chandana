            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="col-xl-6">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-2 col-form-label">Breed Name</label>
                        <div class="col-md-10">
                      ...
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-2 col-form-label">Details</label>
                        <div class="col-md-10">
                          <input class="form-control" type="email" value="-" id="html5-text-input" />
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-number-input" class="col-md-2 col-form-label">Cost</label>
                        <div class="col-md-10">
